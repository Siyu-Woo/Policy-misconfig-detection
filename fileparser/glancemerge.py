...
def normalize_endpoint(endpoint):
    """
    标准化端点URL，用于匹配（移除所有空格）
    """
    return re.sub(r'\s+', '', str(endpoint).strip())
...
def main():
    api_file = 'glance_apis.xlsx'
    policy_file = 'glance_policies.xlsx'
    output_file = 'glance_api_policy_matched.xlsx'
